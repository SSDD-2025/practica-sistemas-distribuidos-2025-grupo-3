...
public class DataLoader {
    ...
    public void run() throws Exception{
        ...
        postRepository.save(new Post("Aprendiendo Spring", "Spring es un framework muy poderoso para desarrollar aplicaciones en Java. Estoy disfrutando mucho aprenderlo.", "imagen3", null, userRepository.findById(1L).get(), communityRepository.findById(1L).get()));
